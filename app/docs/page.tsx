  ...
  return (
    <div className="flex flex-col gap-8 px-6">
      ...
      <div className="flex flex-col gap-3 mb-4">
        ...
        <InputCopy value="npx shadcn@latest add https://cdn.jsdelivr.net/gh/Eldergenix/NexUI-Agentic-UI-Components@main/public/r/button.json" align="left" className="w-fit" />
        <p className="text-[13px] text-muted-foreground">
