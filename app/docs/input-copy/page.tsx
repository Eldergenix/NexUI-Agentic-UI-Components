...
<InputCopy value="npx shadcn@latest add https://cdn.jsdelivr.net/gh/Eldergenix/NexUI-Agentic-UI-Components@main/public/r/input-copy.json" />`;

const labelCode = `import { InputCopy } from "./components";

<InputCopy
  label="Install command"
  value="npx shadcn@latest add https://cdn.jsdelivr.net/gh/Eldergenix/NexUI-Agentic-UI-Components@main/public/r/input-copy.json"
/>`;
...
<InputCopy
  label="Share link"
  value="https://cdn.jsdelivr.net/gh/Eldergenix/NexUI-Agentic-UI-Components@main/public/r/input-copy"
